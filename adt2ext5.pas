...
procedure a2w_lister_external_proc_callback; cdecl; external;
procedure a2w_macro_lister_external_proc_callback; cdecl; external;
...
const
  _4op_flag_chr_beg = #172; // C: charmap.four_op_upper_half
  _4op_flag_chr_end = #173; // C: charmap.four_op_lower_half
  _4op_flag_chars: Set of Char = [_4op_flag_chr_beg,_4op_flag_chr_end];
var
  _4op_flag_column: array[1..255] of Char; cvar; external;
  _a2b_lister_count: Byte; cvar; external;
  _a2w_lister_count: Byte; cvar; external;
...
function check_4op_flag_temp(ins: Byte): Boolean; cdecl; external;
function get_4op_to_test_temp: Word; cdecl; external;
