...
static void Menu1_ShowCStr (tSCREEN_MEM *dest, uint8_t x, uint8_t y,
                            const String *str,
                            uint8_t atr1, uint8_t atr2,
                            uint8_t atr3, uint8_t atr4)
{
  DBG_ENTER ("Menu1_ShowCStr");

  if (mn1_setting.fixed_len == 0)
