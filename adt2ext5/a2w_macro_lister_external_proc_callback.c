...
/*static*/ void a2w_macro_lister_external_proc_callback (void)
{
  uint16_t test_4op_ins;
  uint8_t test_ins1,test_ins2;

  DBG_ENTER ("a2w_macro_lister_external_proc_callback");
...
_exit:
  DBG_LEAVE (); //EXIT //a2w_macro_lister_external_proc_callback
}
