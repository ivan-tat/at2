...
static void fib_lister_external_proc (void)
{
  char s[31+1];

  DBG_ENTER ("fib_lister_external_proc");

  snprintf (s, sizeof (s), "%d.fib", mn_environment.curr_pos);
  ...
  DBG_LEAVE (); //EXIT //fib_lister_external_proc
}
