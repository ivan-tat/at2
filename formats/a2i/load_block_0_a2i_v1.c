...
static int8_t load_block_0_a2i_v1 (uint8_t version, temp_instrument_t *dst,
                                   size_t packed_size,
                                   FILE *f,
                                   progress_callback_t *progress, char **error)
{
  ...
  raw_limit = sizeof (ins_data_a2i_v1_t) + INSTRUMENT_NAME_MAX_A2I_V1;
