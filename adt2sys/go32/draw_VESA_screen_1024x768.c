...
#define IN_TEXT_WIDTH  120
#define IN_TEXT_HEIGHT 46
#define IN_WIDTH  (FONT_WIDTH * IN_TEXT_WIDTH)   // =960
#define IN_HEIGHT (FONT_HEIGHT * IN_TEXT_HEIGHT) // =736
#define OUT_WIDTH  1024 // 128 characters
#define OUT_HEIGHT 768  // 48 characters

static void draw_VESA_screen_1024x768 (void)
{
  ...
  for (uint8_t r = MAX_ROWS; r; r--) // input text screen rows left
  {
    ...
    for (uint8_t fr = 16; fr; fr--) // character's rows left
    {
